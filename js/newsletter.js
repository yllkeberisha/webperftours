document.addEventListener("DOMContentLoaded", function () {
    if (location.href.includes("showNewsletterSignup")) {
        ...
        div.innerHTML = '<h1 style="text-align: center; font-size: ' + fontSize + 'px; line-height: ' + (fontSize * 1.75) + 'px;">Sign up for our newsletter</h1>' +
            '<div style="margin-top: 40px"><label>Email</label><br/><input style="margin-top: 4px; margin-bottom: 10px; padding: 6px; border-radius: 4px;" type="email"/><br/><button onClick="document.querySelector(\'#newsletter\').remove()" style="background: #044262; color: white; border: none; border-radius: 4px; padding: 8px">Subscribe</button></div>'
